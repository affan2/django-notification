...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'notification_noticesetting', 'medium', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'NoticeSetting.medium'
        db.alter_column(u'notification_noticesetting', 'medium', self.gf('django.db.models.fields.CharField')(max_length=1))
